...
var pluginName = 'postcss-critical-css';
...
function buildCritical() {
  ...
  return function (css, result) {
    ...
    return Object.keys(criticalOutput).reduce(function (init, key) {
      var criticalCSS = _postcss2.default.root();
      var filePath = _path2.default.join(outputPath, key);
      criticalOutput[key].each(function (rule) {
...
module.exports = _postcss2.default.plugin(pluginName, buildCritical);