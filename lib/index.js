...
function buildCritical(options) {
  ...
  return function (css) {
    ...
    var criticalOutput = (0, _getCriticalRules.getCriticalRules)(css, preserve, outputDest);
    return Object.keys(criticalOutput).reduce(function (init, cur) {
      ...
      return (0, _postcss2.default)(minify ? [_cssnano2.default] : []).process(criticalCSS).then(dryRunOrWriteFile.bind(null, dryRun, filePath));
    }, {});
  };
}
