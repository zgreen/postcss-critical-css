...
function buildCritical() {
  ...
  var filteredOptions = Object.keys(options).reduce(function(acc, key) {
    return typeof options[key] !== "undefined"
      ? _extends({}, acc, _defineProperty({}, key, options[key]))
      : acc;
  }, {});
  var args = _extends(
    {
  ...
  return function(css) {
    ...
    var criticalOutput = (0, _getCriticalRules.getCriticalRules)(
      css,
      outputDest
    );
    return Object.keys(criticalOutput).reduce(function(init, cur) {
      ...
      return (
        (0, _postcss2.default)(minify ? [_cssnano2.default] : [])
