...
test('creates a critical selector when "this" is used', function(t) {
  compareFixtures(t, 'this');
  t.end();
});

test('creates a custom critical selector', function(t) {
  compareFixtures(t, 'customSelector');
  t.end();
});

test('creates critical selectors within a given scope', function(t) {
  compareFixtures(t, 'scope');
  t.end();
});
